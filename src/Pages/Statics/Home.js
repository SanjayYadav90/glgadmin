            ...
            <div id="mainContent">
                ...
                <div className="masonry-item col-md-6">
                    ...
                    <div className="ta-c bdT w-100 p-20">
                        <Link to="#">Check all the sales</Link>
                    </div>
                    </div>
                </div>
                <div className="masonry-item col-md-6">
